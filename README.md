...
3. Update `spire/version.rb` with a new version number following [Semantic Versioning Rules](https://docs.npmjs.com/about-semantic-versioning#incrementing-semantic-versions-in-published-packages).
